...
/**
 * LCL statement visitor for Xugu.
 */
public final class XuguLCLStatementVisitor extends XuguStatementVisitor implements LCLStatementVisitor {
    
    public XuguLCLStatementVisitor(final DatabaseType databaseType) {
        super(databaseType);
    }
