...
/****
 * Create nested table type statement for Xugu.
 */
@Getter
public final class XuguCreateNestedTableTypeStatement extends CreateTypeStatement {
    ...
    public XuguCreateNestedTableTypeStatement(final DatabaseType databaseType,
