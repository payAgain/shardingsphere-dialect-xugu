...
/**
 * Create object type statement for Xugu.
 */
@Getter
public final class XuguCreateObjectTypeStatement extends CreateTypeStatement {
    ...
    public XuguCreateObjectTypeStatement(final DatabaseType databaseType,
