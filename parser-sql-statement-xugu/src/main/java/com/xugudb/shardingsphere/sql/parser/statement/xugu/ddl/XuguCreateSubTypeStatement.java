...
/**
 * Create sub type statement for Xugu.
 */
@Getter
public final class XuguCreateSubTypeStatement extends CreateTypeStatement {
    ...
    public XuguCreateSubTypeStatement(final DatabaseType databaseType,
