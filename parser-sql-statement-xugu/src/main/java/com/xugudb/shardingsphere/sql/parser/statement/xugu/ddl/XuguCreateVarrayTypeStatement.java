...
/**
 * Create varray type statement for Xugu.
 */
@Getter
@Setter
public final class XuguCreateVarrayTypeStatement extends CreateTypeStatement {
    ...
    public XuguCreateVarrayTypeStatement(final DatabaseType databaseType,
