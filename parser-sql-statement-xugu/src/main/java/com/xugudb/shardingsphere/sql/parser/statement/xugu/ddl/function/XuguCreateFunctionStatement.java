...
package com.xugudb.shardingsphere.sql.parser.statement.xugu.ddl.function;
...
/**
 * Create function statement for Xugu.
 */
@Getter
public final class XuguCreateFunctionStatement extends CreateFunctionStatement {
    
    private final List<SQLStatementSegment> sqlStatements;
    
    private final List<ProcedureCallNameSegment> procedureCallNames;
    
    public XuguCreateFunctionStatement(final DatabaseType databaseType, final List<SQLStatementSegment> sqlStatements, final List<ProcedureCallNameSegment> procedureCallNames) {
        super(databaseType);
