...
package com.xugudb.shardingsphere.sql.parser.statement.xugu.ddl.procedure;
...
/**
 * Create procedure statement for Xugu.
 */
@Getter
public final class XuguCreateProcedureStatement extends CreateProcedureStatement {
    
    private final List<CursorForLoopStatementSegment> cursorForLoopStatements = new ArrayList<>();
    
    public XuguCreateProcedureStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
