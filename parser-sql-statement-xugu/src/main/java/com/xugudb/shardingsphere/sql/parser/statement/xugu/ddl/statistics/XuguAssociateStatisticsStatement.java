...
/**
 * Associate statistics statement for Xugu.
 */
@Getter
@Setter
public final class XuguAssociateStatisticsStatement extends DDLStatement {
    ...
    public XuguAssociateStatisticsStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
