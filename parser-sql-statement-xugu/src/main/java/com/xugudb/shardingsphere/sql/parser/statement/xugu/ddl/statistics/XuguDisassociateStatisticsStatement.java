...
package com.xugudb.shardingsphere.sql.parser.statement.xugu.ddl.statistics;
...
/**
 * Disassociate statistics statement for Xugu.
 */
@Getter
@Setter
public final class XuguDisassociateStatisticsStatement extends DDLStatement {
    ...
    public XuguDisassociateStatisticsStatement(final DatabaseType databaseType) {
        super(databaseType);
    }
}
